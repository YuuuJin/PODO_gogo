...
public:
    ...
    QPushButton *PB_WHEEL_UP;
    QPushButton *PB_WHEEL_DOWN;
    ...
    void setupUi(QDialog *OmniWheelDialog)
    {
        ...
        PB_WHEEL_UP = new QPushButton(OmniWheelDialog);
        PB_WHEEL_UP->setObjectName(QStringLiteral("PB_WHEEL_UP"));
        PB_WHEEL_UP->setGeometry(QRect(300, 120, 91, 31));
        PB_WHEEL_DOWN = new QPushButton(OmniWheelDialog);
        PB_WHEEL_DOWN->setObjectName(QStringLiteral("PB_WHEEL_DOWN"));
        PB_WHEEL_DOWN->setGeometry(QRect(300, 160, 91, 31));
    ...
    void retranslateUi(QDialog *OmniWheelDialog)
    {
        ...
        PB_WHEEL_UP->setText(QApplication::translate("OmniWheelDialog", "Wheel Up", 0));
        PB_WHEEL_DOWN->setText(QApplication::translate("OmniWheelDialog", "Wheel Down", 0));
    } // retranslateUi
