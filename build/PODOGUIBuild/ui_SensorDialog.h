...
public:
    ...
    QLabel *label_66;
    QFrame *line_4;
    QPushButton *BTN_OPT_LAMP_ON;
    QPushButton *BTN_OPT_LAMP_OFF;
    QPushButton *BTN_SENSOR_FOG_USB_RESET;
...
""));
        ...
        gridLayoutWidget_15->setGeometry(QRect(10, 220, 251, 74));
        ...
        label_63->setGeometry(QRect(10, 200, 161, 16));
        ...
        gridLayoutWidget_3->setGeometry(QRect(270, 220, 194, 71));
        ...
        BTN_SENSOR_FOG_NULL->setGeometry(QRect(160, 380, 71, 31));
        ...
        BTN_OPT_LAMP_ON = new QPushButton(groupBox);
        BTN_OPT_LAMP_ON->setObjectName(QStringLiteral("BTN_OPT_LAMP_ON"));
        BTN_OPT_LAMP_ON->setGeometry(QRect(300, 480, 71, 27));
        BTN_OPT_LAMP_ON->setFont(font2);
        BTN_OPT_LAMP_OFF = new QPushButton(groupBox);
        BTN_OPT_LAMP_OFF->setObjectName(QStringLiteral("BTN_OPT_LAMP_OFF"));
        BTN_OPT_LAMP_OFF->setGeometry(QRect(380, 480, 71, 27));
        BTN_OPT_LAMP_OFF->setFont(font2);
        BTN_SENSOR_FOG_USB_RESET = new QPushButton(groupBox);
        BTN_SENSOR_FOG_USB_RESET->setObjectName(QStringLiteral("BTN_SENSOR_FOG_USB_RESET"));
        BTN_SENSOR_FOG_USB_RESET->setGeometry(QRect(160, 410, 71, 31));
        BTN_SENSOR_FOG_USB_RESET->setFont(font2);
        BTN_NEW_IMU_ENABLE = new QPushButton(groupBox);
        BTN_NEW_IMU_ENABLE->setObjectName(QStringLiteral("BTN_NEW_IMU_ENABLE"));
        BTN_NEW_IMU_ENABLE->setGeometry(QRect(10, 300, 80, 22));
        BTN_NEW_IMU_NULL = new QPushButton(groupBox);
        BTN_NEW_IMU_NULL->setObjectName(QStringLiteral("BTN_NEW_IMU_NULL"));
        BTN_NEW_IMU_NULL->setGeometry(QRect(100, 300, 80, 22));
        BTN_NEW_IMU_RESET = new QPushButton(groupBox);
        BTN_NEW_IMU_RESET->setObjectName(QStringLiteral("BTN_NEW_IMU_RESET"));
        BTN_NEW_IMU_RESET->setGeometry(QRect(190, 300, 80, 22));
    ...
    void retranslateUi(QDialog *SensorDialog)
    {
        ...
        BTN_OPT_LAMP_ON->setText(QApplication::translate("SensorDialog", "Lamp On", 0));
        BTN_OPT_LAMP_OFF->setText(QApplication::translate("SensorDialog", "Lamp Off", 0));
        BTN_SENSOR_FOG_USB_RESET->setText(QApplication::translate("SensorDialog", "USB RST", 0));
        BTN_NEW_IMU_ENABLE->setText(QApplication::translate("SensorDialog", "Enable", 0));
        BTN_NEW_IMU_NULL->setText(QApplication::translate("SensorDialog", "Nulling", 0));
        BTN_NEW_IMU_RESET->setText(QApplication::translate("SensorDialog", "Reset", 0));
