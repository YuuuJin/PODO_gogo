...
/* Debug variables (temp) */
    ...
    double CartInitRPos[3];
    double CartInitLPos[3];
...
/* deflection compensator variable */
    ...
    float Measured_Force_Xvel[2]={0,};
    float Measured_Force_Yvel[2]={0,};
    float Measured_Force_Zvel[2]={0,};
    float Measured_Force_Xbef[2]={0,};
    float Measured_Force_Ybef[2]={0,};
    float Measured_Force_Zbef[2]={0,};
    ...
    /* Cart task : End effector pos control*/
    double cart_swing_pos[3] = {0,};
