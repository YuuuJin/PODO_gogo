...
//    //for gazelle
//    double RAP_deg, RAR_deg;
//    GK.FK_diff_Ankle_right(Joint->GetJointRefAngle(RAP) - Joint->GetJointRefAngle(RKN), Joint->GetJointRefAngle(RAR) - Joint->GetJointRefAngle(RKN), 0, 0, RAP_deg, RAR_deg);
//    LJ.RAP = RAP_deg*D2R;
//    LJ.RAR = RAR_deg*D2R;
...
//    //for gazelle
//    double LAP_deg, LAR_deg;
//    GK.FK_diff_Ankle_left(Joint->GetJointRefAngle(LAR) - Joint->GetJointRefAngle(LKN), Joint->GetJointRefAngle(LAP) - Joint->GetJointRefAngle(LKN),0,0,LAP_deg, LAR_deg);
//    LJ.LAP = LAP_deg*D2R;
//    LJ.LAR = LAR_deg*D2R;
