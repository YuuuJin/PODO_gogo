...
/**************************** 0. OnOff Switch ****************************************/
    ...
    double roll_torque_ONOFF =1.0;
    double pitch_torque_ONOFF =1.0;


//    double Gyro_Ankle_FeedBack_ONOFF = 1.0;
//    double roll_torque_ONOFF =0.0;
//    double pitch_torque_ONOFF =0.0;


    double CP_Feedback_ONOFF =0.0;

    double Leg_Length_FeedBack_ONOFF = 0.;
    double Leg_Length_Recover_ONOFF = 0.;
    double EarlyLanding_ONOFF = 1.;
    double Sagging_Comp_ONOFF = 0.;
    double Inv_ONOFF =0.;
    ...
    int     FLAG_SingleLogStart = false;
    int     FLAG_BacktoNormalWalk = 0;
    int     FLAG_TIME = 1;
    int     FLAG_WalkingJoy = false;
...
/* Basic Trajectory */
    ...
    extern _footprint_info    last_target_foot;
...
/* BasicTrajectory mode */
    ...
    typedef struct{
        _footprint FootPrint[100];
        int StepNum;
        double DSPtime[100];
        double SSPtime[100];
    }ManualFootPrint;

    ManualFootPrint MnFootPrint;


/**************************** 2. Variables Definitions (Basic) ***********************/
/* Define */
    double  SSP_TIME = DEF_SSP_TIME;
    double  DSP_TIME = DEF_DSP_TIME;
...
/* GUI Command variable */
    ...
    double     FLAG_CalEncoderFK = false;
...
/* Global Variable For Task Trajecotry (CoM, Foot, Pelvis ori...etc) */
    ...
    double GLOBAL_RHR_Comp = 0.,GLOBAL_LHR_Comp = 0.;
...
/* Ugain */
    double U_Gain  = 0.;
    double U0_Gain  = 0.9;//norml walking
    double U3_Gain = 0.;
    double U_Gain_DSP = 1.;
...
/* Variable for MPC */
    ...
    double MPC_h = 0.83,MPC_g = 9.81,MPC_T = 0.1;
...
/* JoyStick */
    ...
    double Hip_torque = 0.,Hip_torque_ref = 0.;
    double arm_torque = 0.;
...
/* Stabilizer Function */
    ...
    double Hip_torque_generation(int state,int state2,int state3,double ref_zmp_x,double ref_zmp_y,double zmp_x,double zmp_y,double LFoot_x,double RFoot_x,double LFoot_y,double RFoot_y,double FTmx,double Qd0);
...
/* MissionDoor */
    ...
    double UserInput_Pos;
    double pnow, vnow, anow;
    double pi,pf,vi,vf,ai,af;
    double a0,a1,a2,a3,a4,a5;
    double T = 2.0;
    double pvia[3] = {40, 100, 60};
    int FLAG_Interpolation_changed = false;
    double in_pf;
    double in_t;
...
/*  torque & Force Control */
    ...
    double LF_LPF_Fz=0.,RF_LPF_Fz = 0.;
    double LF_LPF_Fx=0.,RF_LPF_Fx = 0.;
    double LF_LPF_Fy=0.,RF_LPF_Fy = 0.;

    double LF_LPF_Mx=0.,RF_LPF_Mx = 0.;
    double LF_LPF_My=0.,RF_LPF_My = 0.;

    double weight = 84.;

    double GLOBAL_CPC_ZMP_Y_REF=0.,CPY_DOT=0.,CPX_DOT=0.,GLOBAL_CPC_ZMP_Y_REF2=0.,GLOBAL_CPC_ZMP_X_REF2=0.,CPC_ZMP_X_REF = 0.,CPC_ZMP_Y_REF=0.,GLOBAL_CPC_ZMP_X_REF=0.,GLOBAL_RDF2=0.,GLOBAL_LDF2=0.;
    double GLOBAL_VAR_GAIN =0.,des_right_roll_torq = 0.,des_left_roll_torq = 0.,des_right_pitch_torq = 0.,des_left_pitch_torq = 0.;

    double GLOBAL_DES_RDF= 0,GLOBAL_DES_LDF = 0,LZctrl=0.0,RZctrl=0.0;

    double GLOBAL_VAR_GAIN_RR = 0.,GLOBAL_VAR_GAIN_RP = 0.,GLOBAL_VAR_GAIN_LR = 0.,GLOBAL_VAR_GAIN_LP = 0.;
    double RDRoll_atc=0.,LDRoll_atc=0.,RDPitch_atc=0.,LDPitch_atc=0.;

    double GLOBAL_Pitch=0.,GLOBAL_Pitch_vel=0.,GLOBAL_Roll=0.,GLOBAL_Roll_vel=0.;
    ...
    double sys_out_zmp_x=0.,sys_out_zmp_y=0.;
    double GLOBAL_Y_LIPM_dd=0.,GLOBAL_X_LIPM_dd=0.,GLOBAL_Y_LIPM_dd_n=0.,GLOBAL_X_LIPM_dd_n=0.;
