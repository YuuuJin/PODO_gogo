...
void THREAD_ReadNewIMU(void){
    ...
    if(mb.status != RBCAN_NODATA){
        ...
        sharedData->IMU[0].Pitch = theta + _DEV_IMU[0].PITCH_OFFSET;
        sharedData->IMU[0].Roll = phi + _DEV_IMU[0].ROLL_OFFSET;
...
//        sharedSEN->IMU[0].YawVel = yaw_vel;
    ...
    if(mb3.status != RBCAN_NODATA){
        ...
        sharedData->IMU[0].Roll_Comp = c_roll;
        sharedData->IMU[0].Pitch_Comp = c_pitch;
        sharedData->IMU[0].Roll_Acc = a_roll;
        sharedData->IMU[0].Pitch_Acc = a_pitch;
